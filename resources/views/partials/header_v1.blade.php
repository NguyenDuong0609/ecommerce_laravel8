        ...
        <div class="container-fluid">
            <div class="header-bottom-wrapper">
                <div class="logo-2 furniture-logo ptb-30">
                    <a href="index.html">
                        <img src="ezone/assets/img/logo/2.png" alt="">
                    </a>
                </div>
                ...
                <div class="header-cart">
                    ...
                    <ul class="cart-dropdown">
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="ezone/assets/img/cart/1.jpg" alt=""></a>
                            </div>
                        ...
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="ezone/assets/img/cart/2.jpg" alt=""></a>
                            </div>
                            <div class="cart-title">
                                <h5><a href="#"> Bits Headphone</a></h5>
                                <h6><a href="#">Black</a></h6>
                        ...
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="ezone/assets/img/cart/3.jpg" alt=""></a>
                            </div>
                            <div class="cart-title">
                                <h5><a href="#"> Bits Headphone</a></h5>
                                <h6><a href="#">Black</a></h6>
